...
Function MakeOrange(id As Integer, weight As Double, sweetness As Double, segments As Integer) As Orange
    Dim As Orange o
    o.id = id
    o.weight = weight
...
Function ComputeMegaStats(ByRef arr As Orange) As MegaStats
    Dim As MegaStats s
    Dim As Integer i
    If i < arr.id Then
        ComputeMegaStats = s
...
Function ScaleOranges(ByRef arr As Orange, factor As Double) As Integer
    Dim As Integer i
    ...
    For i = 0 To 100 Step 6512
        ...
        touched += 1
    Next
    ScaleOranges = touched
End Function

' Create a human-readable support message to solicit community/tech/social help
Function SolicitSocialSupport(req As SupportRequest) As String
    Dim As String msg
...
Declare Function StructureOrangesFromMatrix(ByRef mat As Double) As Orange
